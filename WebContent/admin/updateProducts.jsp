...
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/ProductsServlet?action=updateproducts" method="post">
  &nbsp;
     ...
     <td class="ta_01" bgcolor="#ffffff"> <input type="text" name="name" value="${pd.name }" />
     <td align="center" bgcolor="#f5fafe" class="ta_01">商品价格：</td>
     <td class="ta_01" bgcolor="#ffffff"> <input type="text" name="price" value="${pd.price }"/>
     </td>
     </tr>
     
     <tr>
     <td align="center" bgcolor="#f5fafe" class="ta_01">商品数量：</td>
     <td class="ta_01" bgcolor="#ffffff"> <input type="text" name="pnum" value="${pd.pnum }" />
     </td>
     <td align="center" bgcolor="#f5fafe" class="ta_01">商品类别：</td>
     <td class="ta_01" bgcolor="#ffffff">
       <select name="category" id="category">
           <option value="${pd.category }" selected="selected">--选择商品类别--</option>
     ...
     <tr>
         ...
         <td class="ta_01" bgcolor="#ffffff" colspan="3"> <input type="text" name="imgurl" size="30" value="${pd.imgurl }" />
         </td>
         </tr>
          <tr>
              <td align="center" bgcolor="#f5fafe" class="ta_01">商品描述：</td>
               <td class="ta_01" bgcolor="#ffffff" colspan="3" height="10"> <input type="text" name="pms" size="100" value="${pd.pms }" />
               </td>
               </tr>
         <tr>
